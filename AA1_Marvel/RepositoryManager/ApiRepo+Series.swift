...
extension MarvelRepository {
    ...
    func GetSeries(offset: Int = 0, limit: Int = 20, characterId: Int, onSuccess: @escaping (HeroesContentData) -> (), onError: @escaping (HeroError)->() = {_ in } )
    {
